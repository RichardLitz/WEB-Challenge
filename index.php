...
<html>
    <head>
        ...
        <link rel="preload" as="image" href="./assets/images/logo-inicial.png" />
        <link rel="preload" as="style" href="./assets/css/pages.css" />
    ...
    <body>
        ...
        <div class="wrapper-page">
            ...
            <form class="form-horizontal m-t-20" action="verifica-login.php" method="post">
