<div class="dataTables_paginate paging_simple_numbers" id="idPaginacao">
    <ul class="pagination">
        <?php
        $quant_pg = ceil($quantreg/$_SESSION["s_QtdResultadoBuscaMonitoramento"]);
        $quant_pg++;
        ...
        if($pg > 0)
        {
            ?>
            <li class='previous' aria-controls='datatable-buttons' tabindex='0' id='datatable-buttons_previous'>
                <a href="<?php echo $_SESSION["s_Patch"]; ?>/modulos/<?php echo $_SESSION["s_TipoAplic"]; ?>/<?php echo $_SESSION["s_PastaAplic"]; ?>/<?php echo trim($_SESSION["s_ArqImprimir"]); ?>?pg=<?php echo ($pg-1); ?>&f_Campo1=<?php echo $f_Campo1; ?>&f_Campo2=<?php echo $f_Campo2; ?>&f_Campo3=<?php echo $f_Campo3; ?>&f_Campo4=<?php echo $f_Campo4; ?>&f_Campo5=<?php echo $f_Campo5; ?>&f_Campo6=<?php echo $f_Campo6; ?>&f_Campo7=<?php echo $f_Campo7; ?>&f_Campo8=<?php echo $f_Campo8; ?>&f_Campo9=<?php echo $f_Campo9; ?>&f_Campo10=<?php echo $f_Campo10; ?>&f_Campo11=<?php echo $f_Campo11; ?>&f_Campo12=<?php echo $f_Campo12; ?>&f_Campo13=<?php echo $f_Campo13; ?>&f_Campo14=<?php echo $f_Campo14; ?>&CdBusca=<?php echo $CdBusca; ?>" title='Anterior'>
                    Anterior
                </a>
            </li>
            <?php
        ...
        if (($pg+2) < $quant_pg)
        {
            ?>
            <li class='previous' aria-controls='datatable-buttons' tabindex='0' id='datatable-buttons_previous'>
            <a href="<?php echo $_SESSION["s_Patch"]; ?>/modulos/<?php echo $_SESSION["s_TipoAplic"]; ?>/<?php echo $_SESSION["s_PastaAplic"]; ?>/<?php echo trim($_SESSION["s_ArqImprimir"]); ?>?pg=<?php echo ($quant_pg-2); ?>&f_Campo1=<?php echo $f_Campo1; ?>&f_Campo2=<?php echo $f_Campo2; ?>&f_Campo3=<?php echo $f_Campo3; ?>&f_Campo4=<?php echo $f_Campo4; ?>&f_Campo5=<?php echo $f_Campo5; ?>&f_Campo6=<?php echo $f_Campo6; ?>&f_Campo7=<?php echo $f_Campo7; ?>&f_Campo8=<?php echo $f_Campo8; ?>&f_Campo9=<?php echo $f_Campo9; ?>&f_Campo10=<?php echo $f_Campo10; ?>&f_Campo11=<?php echo $f_Campo11; ?>&f_Campo12=<?php echo $f_Campo12; ?>&f_Campo13=<?php echo $f_Campo13; ?>&f_Campo14=<?php echo $f_Campo14; ?>&CdBusca=<?php echo $CdBusca; ?>" title='Última'>
                Última
            </a>
        </li>
            <?php
