...
(function($) {
    ...
    var historicalBarChart = [{
        ...
        values: [<?php echo trim($ValorGrafico); ?>]
    }];
    nv.addGraph(function() {
        ...
        barChart.yAxis.axisLabel('Entregas do Dia');
    ...
    var historicalBarChart2 = [{
        ...
        values: [<?php echo substr(trim($ValorGraficColuna),0,-1); ?>]
    }];
    nv.addGraph(function() {
        var barChart = nv.models.discreteBarChart().x(function(d) {
            return d.label;
        ...
        barChart.yAxis.axisLabel('Qtd. Propostas');
        d3.select('.bar-chart2 svg').datum(historicalBarChart2).call(barChart);
        nv.utils.windowResize(barChart.update);
        return barChart;
    });
	...
	function exampleData() {
	  return  [
	      <?php echo substr(trim($ValorGraficoPizza),0,-1); ?>
	    ];
	}
})(jQuery);
