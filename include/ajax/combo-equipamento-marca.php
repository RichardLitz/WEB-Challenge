<div class="form-group">
    ...
    ?>
    <select class="form-control select2" name="f_CdEquipMarca" id="f_CdEquipMarca" onchange="return f_BuscaEquipModelo(document.getElementById('f_CdEquipMarca').value,'<?php echo $_SESSION["s_Patch"]; ?>','');">
