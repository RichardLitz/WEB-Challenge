...
if($CdAlterar != "")
{
    $cSQL = "SELECT aplicacao.cd_tipo_acesso
               FROM aplicacao,
                    perfil_permissao
              WHERE perfil_permissao.cd_perfil = ".trim($CdAlterar)."
                AND perfil_permissao.status = 'ATIVO'
                AND aplicacao.cd_aplic = perfil_permissao.cd_aplic
                LIMIT 1";
    ...
    $CdTipoAcesso = $ResultUpdate['cd_tipo_acesso'];
}
else
{
    $CdTipoAcesso = $TipoUsuario;
}
    ...
    <?php
        ...
        $cSQL = "SELECT menu.icone,
                  ...
                  WHERE menu.status = 'ATIVO'
                    ...
                    AND aplicacao.cd_tipo_acesso = ".$CdTipoAcesso."
                    AND menu.cd_menu = aplicacao.cd_menu
               GROUP BY menu.cd_menu
        ...
        while($ResultMenu = mysqli_fetch_array($oRSmenu))
        {
            ...
            <div class="col-md-12 p-20 list-group">
                ...
                $cSQL = "SELECT *
                      ...
                      WHERE status = 'ATIVO'
                        AND cd_menu = ".$cd_menu."
                        AND cd_tipo_acesso = ".$CdTipoAcesso."
