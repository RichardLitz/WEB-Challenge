...
?>
        <div class="form-group">
            <label for="f_CdEstadoCorrespondencia">Estado</label>
            <select class="form-control select2" name="f_CdEstadoCorrespondencia" id="f_CdEstadoCorrespondencia">
        ...
        <div class="form-group">
            <label for="f_CdCidadeCorrespondencia">Cidade</label>
            <select class="form-control select2" name="f_CdCidadeCorrespondencia" id="f_CdCidadeCorrespondencia">
